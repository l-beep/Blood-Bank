...
import fragments.AchievmentsView;
import fragments.BloodInfo;
import fragments.HomeView;
import fragments.NearByHospitalActivity;
...
public class Dashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        singleuser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //pd.show();
                String name = dataSnapshot.(UserData.class).getName();
    ...
    private TextView findViewById(int userEmailView) {
        return null;
    }
